function call_glmnet_combinedwpopmean_orchestra_binomial_r(base,filters_to_keep,cel)
...
[big_matrixpop,big_matrix_idspop] = make_big_matrix_final_cellsonly(popmean,filters_to_keep);
...
save([base 'single_glmnet_combinedwpopmean_binomial_' num2str(cel)], 'single_glmnet')
